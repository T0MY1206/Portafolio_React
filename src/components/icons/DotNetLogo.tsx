/**
 * Logo oficial .NET (Microsoft dotnet/brand).
 * Solo el símbolo (punto + "net") con currentColor para integrar con el fondo de la card.
 * https://github.com/dotnet/brand
 */
export default function DotNetLogo({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 456 456"
